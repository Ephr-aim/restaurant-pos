...
Route::prefix('admin')->as('backend.admin.')->middleware(['admin'])->group(function () {
    ...
    Route::get('cottages/orders/{id}', [CottageController::class, 'orders'])->name('cottages.orders');
   ...
   // start pos
    ...
    Route::get('/get/cottages',[CottageController::class,'getCottages']);
    Route::post('/create/cottages', [CottageController::class, 'store']);
    //end pos
