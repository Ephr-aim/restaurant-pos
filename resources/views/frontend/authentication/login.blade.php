...
<body>
    ...
    <section class="authentications">
        <div class="left-content">
            <figure class="">
                <img src="https://images.unsplash.com/photo-1568901346375-23c9450c58cd?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="burger dish" style="width:100%;height:100vh;object-fit:cover;">
            </figure>
        </div>
        <div class="right-content">
            <form action="{{ route('login') }}" method="post" class="authentication-form px-lg-5 needs-validation"
                ...
                <div class="authentication-form-header">
                    ...
                    <h1 class="brand-name" style="color: #333; font-weight: bold; margin: 10px 0; font-size: 24px;">BULANDA CANTEEN</h1>
