...
<div class="sidebar">
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item {{ request()->routeIs(['backend.admin.cottages.index', 'backend.admin.cottages.create', 'backend.admin.cottages.edit','backend.admin.suppliers.index', 'backend.admin.suppliers.create', 'backend.admin.suppliers.edit']) ? 'menu-open' : '' }}">
                ...
                <ul class="nav nav-treeview">
                    @if (auth()->user()->hasAnyPermission(['cottage_create','cottage_view','cottage_update','cottage_delete']))
                    <li class="nav-item">
                        <a href="{{route('backend.admin.cottages.index')}}"
                            class="nav-link {{ request()->routeIs(['backend.admin.cottages.index','backend.admin.cottages.edit','backend.admin.cottages.create']) ? 'active' : '' }}">
