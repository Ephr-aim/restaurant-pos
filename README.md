...
- Open an issue on the [GitHub repository](https://github.com/Ephr-aim/restaurant-pos).
- **Call for Queries**: +254742628281 (WhatsApp)
- **Email**: [techlink.dvpt@gmail.com.com]
